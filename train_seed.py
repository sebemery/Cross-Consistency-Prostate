...
def main(config, resume1, resume2, resume3, resume4, resume5, resume6, sites, seeds):
    if sites == 'All':
        for seed in seeds:
            train_multi.main(config, resume1, resume2, resume3, resume4, resume5, resume6, seed)
    else:
        for seed in seeds:
            train_single.main(config, resume1, sites, seed)
